I recently made a news web app that runs on voice recognition and shows real-time news by source, categories, etc. It is built with ReactJS, Material-UI and Alan AI.
